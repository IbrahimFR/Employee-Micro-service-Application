...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("EmployeeMicroServices");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("EmployeeMicroServices");
        ...
        config.getMapConfigs().put("com.assignment.employee.domain.*", initializeDomainMapConfig(jHipsterProperties));
